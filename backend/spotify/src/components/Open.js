        ...
        <div className="open_display">
            <div className="top_div">
                ...
                <div className="open_bottom_area" style={{'backgroundImage': `linear-gradient(180deg,rgba(77,23,37,255),rgba(18,19,19,255)`}}>
                    ...
                    <OpenSonglist songlist={song_data} type={'music'} tracklist={props.track} actvfn={props.actvfn} trackfn={props.trackfn} ctrack={props.current_track}/>
                </div>
            </div>
        )
    }
        ...
        <div className="open_display">
            <div className="top_div">
                ...
                <div className="open_bottom_area" style={{'backgroundImage': `linear-gradient(180deg,rgba(21,35,79,255),rgba(18,19,19,255)`}}>
                    ...
                    <OpenSonglist ctrack={props.current_track} trackfn={props.trackfn} songlist={artist_song_data} tracklist={props.track} type={'artist'} actvfn={props.actvfn}/>
                    <div className="about">
                        <h1>About</h1>
                        <br />
        ...
        <div className="open_display">
            <div className="top_div">
                ...
                <div className="open_bottom_area" style={{'backgroundImage': `linear-gradient(180deg,rgba(77,23,37,255),rgba(18,19,19,255)`}}>
                    ...
                    <OpenSonglist ctrack={props.current_track} trackfn={props.trackfn} songlist={song_data} tracklist={props.track} type={'album'} actvfn={props.actvfn}/>
                </div>
            </div>
        )
    }
